...
export default function Footer() {
  return (
    <footer className="bg-[#2851A3] text-white" dir="rtl">
      <div className="max-w-7xl mx-auto px-4 py-16">
        {/* Newsletter Section - Full Width on Mobile */}
        <div className="mb-16 lg:mb-20 max-w-xl">
          <h2 className="text-2xl font-bold mb-2">عضویت در خبرنامه</h2>
          <p className="text-blue-100 mb-4">
            از آخرین قیمت‌ها، تحلیل‌ها و اخبار بازار طلا و ارز مطلع شوید
          </p>
          ...
          <div className="lg:col-span-2 space-y-8">
            <div>
              ...
              <p className="text-blue-100 text-sm leading-relaxed mb-4">
                زیبوکو، پیشرو در ارائه خدمات خرید و فروش طلا و جواهر با بیش از یک دهه تجربه درخشان
              </p>
            </div>

            <div>
              <h3 className="text-lg font-bold mb-2">مشاوره رایگان</h3>
              <a href="tel:02112345678" className="text-2xl lg:text-3xl font-bold hover:text-blue-200 transition-colors">
                ۰۲۱-۲۳۴۵۶۷۸۹
              </a>
              <p className="text-blue-200 text-sm mt-1">شنبه تا پنجشنبه ۹ صبح تا ۵ عصر</p>
            </div>
        ...
        <div className="border-t border-blue-400/30 pt-8">
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 items-center justify-items-center mb-12">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="bg-white/10 rounded-lg p-4 w-full max-w-[160px] aspect-[3/2] flex items-center justify-center">
                <Image 
                  src="/placeholder.png" 
                  alt={`Trust Badge ${i}`} 
                  width={100} 
          ...
          <div className="text-sm text-blue-100 space-y-6">
            <div className="grid gap-4 text-center">
              ...
              <p className="max-w-3xl mx-auto">
                استفاده از مطالب سایت زیبوکو فقط برای مقاصد غیرتجاری و با ذکر منبع بلامانع است.
                کلیه حقوق این سایت متعلق به شرکت زیبوکو می‌باشد.
              </p>
            </div>

            {/* Payment Methods */}
            <div className="flex flex-wrap justify-center gap-4">
              {["visa", "mastercard", "amex", "discover", "paypal"].map((payment) => (
                <div key={payment} className="bg-white/10 p-2 rounded-lg">
                  <Image
                    src="/placeholder.png"
                    alt={payment}
                    width={40}
