...
export const fakeData: FakeDataType = {
	...
	products: [
		// Regular products
		{
			...
			image: [DEFAULT_IMAGE, "/3dicons-treasure-front-color-500-500.png", "/3dicons-wallet-front-color-500-500.png"],
			price: 25_000_000,
			tag: "پرفروش",
			onSale: false,
			hot: false,
		...
		},
		{
			...
			image: [DEFAULT_IMAGE, "/3dicons-wallet-front-color-500-500.png"],
			price: 2_500_000,
			tag: "جدید",
			onSale: false,
			hot: false,
